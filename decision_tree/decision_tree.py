...
class DecisionTree:
    ...
    def ___pick_attribute(self, attributes, target_attribute, data):
        ret = None
    ...
    def generate(self, Data, Attributes, TargetAttribute):
        ...
        while open_tab != []:
            ...
            best_attribute = self.___pick_attribute(Attributes, TargetAttribute, front[1])
    ...
    def __be_of_the_same_class(self, attributes, target_attribute, data):
        try:
            i = attributes.index(target_attribute)
        except ValueError:
            raise DecisionTreeException(0)
    ...
    def __repr__(self):
        raise NotImplementedError("May be implemented...")
